...
INSERT INTO Reservations (CustomerID, PartySize, Date) VALUES (SELECT CustomerID FROM Customers WHERE Customers.FirstName = 'Sam' AND Customers.LastName = 'McAdams', 5, '2022-