...
INSERT INTO CustomerDelivery (CustomerID, FirstName, LastName, Address, Items, DeliveryDate_Time, Total) 
VALUES((SELECT CustomerID, FirstName, LastName, Address FROM Customers WHERE Customers.FirstName = 'Loretta' AND Customers.LastName = 'Hundey') );