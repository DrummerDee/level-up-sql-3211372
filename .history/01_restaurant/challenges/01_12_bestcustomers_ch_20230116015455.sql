...
SELECT SUM(Orders.OrderID) AS AmountOfOrders, Customers.FirstName, Customers.LastName, Customer FROM Customers JOIN Orders ON Orders.CustomerID = Customers.CustomerID GROUP BY OrderID 
