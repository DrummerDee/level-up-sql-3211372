...
INSERT INTO CustomerDelivery (Items) SELECT Name FROM OrdersDishes JOIN Dishes ON OrdersDishes.DishID = Dishes.DishID WHERE OrderID = 1001;
...
DELETE FROM CustomerDelivery WHERE Total > 20
