...
INSERT INTO OrdersDishes (OrderID, DishID) VALUES (1001, (SELECT DishID FROM Dishes WHERE Name = ('House Salad', 'Tropical Blue Smoothie', 'Mini Cheeseburgers'))
INSERT INTO OrdersDishes (OrderID, DishID) VALUES (1001, (SELECT DishID FROM Dishes WHERE Name IN ('House Salad', 'Tropical Blue Smoothie', 'Mini Cheeseburgers'))
INSERT INTO OrdersDishes (OrderID, DishID) VALUES (1001, (SELECT DishID FROM Dishes WHERE Name IN ('House Salad', 'Tropical Blue Smoothie', 'Mini Cheeseburgers'))
