...
SELECT SUM(Orders.OrderID) AS AmountOfOrders, Customers.FirstName, Customers.LastName, Customers.Email FROM Customers JOIN Orders ON Orders.CustomerID = Customers.CustomerID GROUP BY OrderID 
