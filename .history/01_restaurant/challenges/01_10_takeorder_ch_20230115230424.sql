...
((SELECT CustomerID, FirstName, LastName, Address FROM Customers WHERE Customers.FirstName = 'Loretta' AND Customers.LastName = 'Hundey'), (SELECT Name FROM Dishes WHERE 
