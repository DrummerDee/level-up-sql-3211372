...
INSERT INTO CustomerDelivery (CustomerID, FirstName, LastName, Address) SELECT CustomerID, FirstName, LastName FROM Customers WHERE CustomerID = 70;

--Check Customer delivery database 
SELECT * FROM CustomerDelivery

DELETE FROM CustomerDelivery WHERE Total > 150