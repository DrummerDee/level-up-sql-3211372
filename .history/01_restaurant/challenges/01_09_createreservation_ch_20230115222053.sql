...
INSERT INTO Reservations (SELECT CustomerID FROM Customers WHERE Customers.FirstName = 'Sam' AND Customers.LastName = 'McAdams', PartySize, Date) VALUES (PartySize