...
--Check is person exists in customer database (He does not, I have to add him)
SELECT * FROM Customers WHERE EXISTS(SELECT FirstName AND LastName WHERE Customers.FirstName ='Sam' AND Customers.LastName = 'McAdams');
